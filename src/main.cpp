...
/** \mainpage RoboComp::bitalino
 *
 * \section intro_sec Introduction
 *
 * The bitalino component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/bitalino --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class bitalino : public RoboComp::Application
{
public:
	bitalino (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::bitalino::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
